CREATE OR REPLACE PROCEDURE MERGER_BUILDER_GEN(table_name VARCHAR,schema_name VARCHAR, stage_name VARCHAR)
...
try {
	var v_sql_stmt = `CREATE OR REPLACE temporary TABLE vars_of_merger_dyn00 AS 
					...
					||CASE  WHEN cons.data_type ='FLOAT' THEN '0' 
							WHEN cons.data_type ='NUMBER' THEN '0' ELSE '-999999' END||') = nvl(src."' 
							||cons.constraint_name ||'",'
					||CASE  WHEN cons.data_type ='FLOAT' THEN '0' 
							WHEN cons.data_type ='NUMBER' THEN '0' ELSE '-999999' END  ,') and \n') ||')','-999999','''''') AS dd
					...
					||CASE  WHEN intab.data_type ='FLOAT' THEN '0' 
							WHEN intab.data_type ='NUMBER' THEN '0' ELSE '-999999' END
					||') != nvl(src."' ||InTab.COLUMN_NAME||'",'||CASE  WHEN intab.data_type ='FLOAT' THEN '0' 
							WHEN intab.data_type ='NUMBER' THEN '0' ELSE '-999999' END 
...
--CALL MERGER_BUILDER_GEN('DEBTOR','WS_EA_DNATA_DEV','ext_stage_diaop_brand'); example 